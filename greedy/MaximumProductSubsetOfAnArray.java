package greedy;
// find maximum product of a subsequence or subset of an array 
...
//	If there are odd number of negative numbers and no zeros, result is product of all except
//	the negative integer with the least absolute value.
...
//	In this case, result is 0.
	...
	static int maxProductSubset(int a[], int n) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (a[i] < 0) {
                count_neg++;
                // find the smallest absolute value of negative number
	...
	public static void main(String[] args) {
        ...
        int a1[] = {1, 2, -6, -3, -50};
        System.out.println(maxProductSubset(a1, a1.length));
